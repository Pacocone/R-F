  // Aplica clase RTL al body si el idioma es árabe
  if (lang === 'ar') {
    document.body.classList.add('arabic-rtl');
  } else {
    document.body.classList.remove('arabic-rtl');
  }
...
function setLang() {
  ...
  // Cambia la dirección de los desplegables si el idioma es árabe
  const selects = document.querySelectorAll('select');
  if (lang === 'ar') {
    selects.forEach(sel => sel.setAttribute('dir', 'rtl'));
  } else {
    selects.forEach(sel => sel.setAttribute('dir', 'ltr'));
  }
